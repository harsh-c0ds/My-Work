...
!***********************************************************************
  ...
  CALL MPI_File_set_size(fh, 0_MPI_OFFSET_KIND)  ! removes the whole content if the file already existed
                           ! 0_MPI_OFFSET_KIND is an INTEGER(KIND=MPI_OFFSET_KIND) constant with value 0
