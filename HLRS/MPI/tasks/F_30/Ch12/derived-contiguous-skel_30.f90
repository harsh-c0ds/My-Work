...
!==============================================================!
  ...
  !_________________ :: send_recv_type
  ...
  DO i = 1, size
     CALL MPI_Issend(snd_buf, 2, MPI_INTEGER, right, 17, MPI_COMM_WORLD, request) ! Step 2a
     CALL MPI_Recv(rcv_buf, 2, MPI_INTEGER, left, 17, MPI_COMM_WORLD, status)     ! Step 3
