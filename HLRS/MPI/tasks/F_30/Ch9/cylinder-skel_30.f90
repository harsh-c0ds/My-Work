...
! use MPI_Cart_rank
  ...
  END DO
  coords(1)=________________; CALL MPI_Cart_rank(________________, left);
  coords(1)=________________; CALL MPI_Cart_rank(________________, right);
