...
!==============================================================!
  ...
  snd_counts(1) __________________________________________________
  snd_counts(2) __________________________________________________
...
!     IF (.NOT.MPI_ASYNC_PROTECTS_NONBLOCKING) CALL MPI_F_sync_reg(snd_buf)
     ...
     IF (.NOT.MPI_ASYNC_PROTECTS_NONBLOCKING) CALL MPI_F_sync_reg(_______)
     IF (.NOT.MPI_ASYNC_PROTECTS_NONBLOCKING) CALL MPI_F_sync_reg(_______)

     CALL MPI_Neighbor_alltoallw(__________, snd_counts, snd_displs, snd_types, &
                                 __________, rcv_counts, rcv_displs, rcv_types, new_comm)
