...
#        in1 = ___________________________________ # number of processes that must have "inner0+1" unknowns
        if (icoord < in1):  # the first in1 processes will have "iinner0+1" unknowns
#            iinner = ___________
#            iss = __________________________________ # note that "is" reflects the position of the 
            pass                                     # first halo or boundary element of the subdomain
        else:               # and all other processes will have iinner0 unknowns
#            iinner = _________
#            iss = ____________________________________________
            pass
#        iouter = ____________
#        ie = _______________
