...
#
# Compile @login node:   mpiicc -o data-rep_exercise data-rep_exercise.c
#                        mpiifort -o data-rep_exercise data-rep_exercise_30.f90
#     
...
date
  mpirun -n $MPI_PROCESSES ./data-rep_exercise
date
