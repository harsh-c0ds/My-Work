...
# @jit("float64(int64, int64, float64, float64)", nopython=True,fastmath=True)
def f_sum(n_start,n_end, w, sum):
...
w=1.0/n
p_sum = 0.0
p_sum = np.array(f_sum(sub_start,sub_start+sub_n, w, p_sum), dtype=np.double)
