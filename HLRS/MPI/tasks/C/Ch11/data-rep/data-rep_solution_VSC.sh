...
#SBATCH -N 4                        # SLURM_JOB_NUM_NODES    ==> @course [1-4]
...
#
# Compile @login node:   mpiicc -o data-rep_solution data-rep_solution.c
#                        mpiifort -o data-rep_solution data-rep_solution_30.f90
#     
...
date
  mpirun -n $MPI_PROCESSES ./data-rep_solution
date
