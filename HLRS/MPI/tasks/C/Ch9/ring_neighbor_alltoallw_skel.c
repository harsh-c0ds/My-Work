...
int main (int argc, char *argv[])
{
  ...
  snd_counts[0] ________________________________________
  snd_counts[1] ________________________________________
  ...
  for( i = 0; i < size; i++) 
  {
    ...
    */    
    MPI_Neighbor_alltoallw(__________, snd_counts, snd_displs, snd_types, 
