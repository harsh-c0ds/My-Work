...
! CREATE THE WINDOW.
  ...
  CALL MPI_Alloc_mem(rcv_buf_size, MPI_INFO_NULL, ptr_rcv_buf)
! CALL C_F_POINTER(ptr_rcv_buf, rcv_buf, (/shape_of_number_of_elements/)) ! if rcv_buf is an array
  CALL C_F_POINTER(ptr_rcv_buf, rcv_buf)
