...
C         CALL MPI_GET_ADDRESS(rcv_buf, iadummy, ierror)
C     TO DO NOTHING IS WRONG AND MAY DEFINITELY CAUSE WRONG RESULTS
...
C         CALL MPI_GET_ADDRESS(snd_buf, iadummy, ierror)
C     TO DO NOTHING IS WRONG AND MAY DEFINITELY CAUSE WRONG RESULTS
