...
int main (int argc, char *argv[])
{
  ...
  if ((dest>=0) && (dest<size)) {
    ...
    MPI_Isend(&snd_buf_A,1,MPI_INT, dest,222,MPI_COMM_WORLD, &snd_rq[number_of_dests]); /* WRONG because it must by synchronous Issend */
  ...
  if ((dest>=0) && (dest<size)) {
    ...
    MPI_Isend(&snd_buf_B,1,MPI_INT, dest,222,MPI_COMM_WORLD, &snd_rq[number_of_dests]); /* WRONG because it must by synchronous Issend */
  ...
  if ((dest>=0) && (dest<size)) {
    ...
    MPI_Isend(&snd_buf_C,1,MPI_INT, dest,222,MPI_COMM_WORLD, &snd_rq[number_of_dests]); /* WRONG because it must by synchronous Issend */
  ...
  if ((dest>=0) && (dest<size)) {
    ...
    MPI_Isend(&snd_buf_D,1,MPI_INT, dest,222,MPI_COMM_WORLD, &snd_rq[number_of_dests]); /* WRONG because it must by synchronous Issend */
