...
/*              halo-communication                 halo-communication                */
  ...
  MPI_Win_allocate_shared((MPI_Aint)(signal_distance*sizeof(int)), sizeof(int), MPI_INFO_NULL, MPI_COMM_WORLD,&signal_A_left_ptr, &win_signal_A_left);
  *signal_A_left_ptr = 0;
  MPI_Win_fence(0,win_signal_A_left);
  MPI_Win_lock_all(MPI_MODE_NOCHECK, win_signal_A_left);

  MPI_Win_allocate_shared((MPI_Aint)(signal_distance*sizeof(int)), sizeof(int), MPI_INFO_NULL, MPI_COMM_WORLD,&signal_A_right_ptr, &win_signal_A_right);
  *signal_A_right_ptr = 0;
  MPI_Win_fence(0,win_signal_A_right);
  MPI_Win_lock_all(MPI_MODE_NOCHECK, win_signal_A_right);

  MPI_Win_allocate_shared((MPI_Aint)(signal_distance*sizeof(int)), sizeof(int), MPI_INFO_NULL, MPI_COMM_WORLD,&signal_B_left_ptr, &win_signal_B_left);
  *signal_B_left_ptr = 0;
  MPI_Win_fence(0,win_signal_B_left);
  MPI_Win_lock_all(MPI_MODE_NOCHECK, win_signal_B_left);

  MPI_Win_allocate_shared((MPI_Aint)(signal_distance*sizeof(int)), sizeof(int), MPI_INFO_NULL, MPI_COMM_WORLD,&signal_B_right_ptr, &win_signal_B_right);
